# Software
In order to use any software tools you'll have to run the Vitis setup script. It's in `Vitis/2024.2/settings64.sh`, wherever you installed Vitis (ex: `~/embedded/Vitis/2024.2/settings64.sh`)
