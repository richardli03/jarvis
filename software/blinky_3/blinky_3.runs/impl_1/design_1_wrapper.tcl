namespace eval ::optrace {
  variable script "/home/drew/Documents/github/jarvis/software/blinky_3/blinky_3.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "create in-memory project" START { }
  ...
  set_property board_part_repo_paths {/home/drew/Documents/github/vivado-boards/new/board_files} [current_project]
  set_property board_part digilentinc.com:zybo:part0:2.0 [current_project]
  set_property design_mode GateLvl [current_fileset]
  set_param project.singleFileAddWarning.threshold 0
OPTRACE "create in-memory project" END { }
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir /home/drew/Documents/github/jarvis/software/blinky_3/blinky_3.cache/wt [current_project]
  set_property parent.project_path /home/drew/Documents/github/jarvis/software/blinky_3/blinky_3.xpr [current_project]
  set_property ip_output_repo /home/drew/Documents/github/jarvis/software/blinky_3/blinky_3.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet /home/drew/Documents/github/jarvis/software/blinky_3/blinky_3.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files /home/drew/Documents/github/jarvis/software/blinky_3/blinky_3.srcs/sources_1/bd/design_1/design_1.bd
