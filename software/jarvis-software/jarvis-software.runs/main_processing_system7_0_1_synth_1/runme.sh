...
HD_PWD='/home/richard/code/jarvis/software/jarvis-software/jarvis-software.runs/main_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_processing_system7_0_1.tcl
