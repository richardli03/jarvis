...
HD_PWD='/home/drew/Documents/github/jarvis/software/blinky/blinky.runs/blinky_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blinky_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blinky_processing_system7_0_0.tcl
