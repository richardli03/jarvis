...
set rc [catch {
  ...
  set_param synth.incrementalSynthesisCache ./.Xil/Vivado-359078-beep-box/incrSyn
  set_param runs.launchOptions { -jobs 8  }
  open_checkpoint blinky_wrapper_routed.dcp
  set_property webtalk.parent_dir /home/richard/code/jarvis/software/blinky/blinky.cache/wt [current_project]
set_property TOP blinky_wrapper [current_fileset]
