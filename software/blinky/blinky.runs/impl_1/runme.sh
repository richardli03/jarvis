...
HD_PWD='/home/drew/Documents/github/jarvis/software/blinky/blinky.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log blinky_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source blinky_wrapper.tcl -notrace
