...
HD_PWD='/home/drew/Documents/github/jarvis/software/blinky/blinky.runs/blinky_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blinky_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blinky_axi_gpio_0_0.tcl
