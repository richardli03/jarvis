...
set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports {leds_4bits_tri_o[0]}]
...
###LEDs
set_property IOSTANDARD LVCMOS33 [get_ports out_test_high]
set_property LOC M15 [get_cells out_test_high_OBUF_inst]
...
set_property LOC M14 [get_cells leds_4bits_tri_o_OBUF[1]_inst ]
