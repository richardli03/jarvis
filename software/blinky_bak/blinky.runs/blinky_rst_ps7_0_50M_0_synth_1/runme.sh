...
HD_PWD='/home/drew/Documents/github/jarvis/software/blinky/blinky.runs/blinky_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blinky_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blinky_rst_ps7_0_50M_0.tcl
