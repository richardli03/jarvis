...
# Create directories
file mkdir bit/
file mkdir synth_log/
file mkdir backup_log/
file mkdir vivado_log/
...
report_drc -file synth_log/drc.log -verbose
write_checkpoint -force checkpoints/synthesis.checkpoint
opt_design
# power_opt_design # Not needed for now

# Reports
report_timing_summary -file synth_log/timing_summary.log
report_timing -sort_by group -max_paths 100 -path_type summary -file synth_log/timing.log -verbose
report_utilization -file synth_log/utilization.log -verbose
report_utilization -hierarchical -file synth_log/utilization_by_module.log -verbose
...
report_clocks -file synth_log/clocks.log
